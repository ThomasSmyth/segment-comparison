...
.segComp.leaderboard:{[dict]
  ...
  athleteName:`$" " sv athleteData`firstname`lastname;
  empty:![([] Segment:());();0b;enlist[athleteName]!()];
...
.return.leaderboard.all:{[dict]
  ...
  rs:([athlete_id:`long$()] athlete_name:(); moving_time:`minute$(); Segment:`long$());
